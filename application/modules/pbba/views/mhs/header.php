...
<html>
    <head>
        ...
        <title>Ujian TOEFL and TOAFL</title>
	...
	<div id="top-header"></div>
		<div id="body">
			<div id="header">
				<div class="logo-uin">	</div>
				<div id="name">
					<div class="system-name"><b>SISTEM INFORMASI AKADEMIK</b></div>
					<div class="universitas-name"><b>SUNAN KALIJAGA</b></div>
					<div class="facultas-name"><b>FAKULTAS SAINS DAN TEKNOLOGI</b></div>		
				</div>
			</div>
<div id="main">
